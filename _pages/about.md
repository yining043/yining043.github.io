...
- **<font color='#2d57d1'>Neural Combinatorial Optimization (NCO)</font>**  - Learning end-to-end GPU-based solvers, e.g., [DACT](https://github.com/yining043/VRP-DACT)/[NeuOpt](https://github.com/yining043/NeuOpt) (k-opt search), [N2S](https://github.com/yining043/PDP-N2S)/[NCS](https://ieeexplore.ieee.org/document/10663917) (ruin-and-repair search), [NeuOpt](https://github.com/yining043/NeuOpt)/[PIP](https://github.com/jieyibi/pip-constraint) (constraint handling), [AMDKD](https://github.com/jieyibi/AMDKD) (generalization), [NHDE](https://github.com/bill-cjb/NHDE) (multi-objective), [MVMoE](https://github.com/RoyalSkye/Routing-MVMoE) (multi-task) 
