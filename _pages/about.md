...
My backgroud unites **Artificial Intelligence (AI)**, **Operations Research (OR)**, and **Systems Design**, aiming to turn algorithms into trustworthy industrial and societal solutions across supply chains, transportation, robotics, LLM systems, advanced manufacturing, and beyond. I have published 35+ papers in top-tier conferences such as *ICML*, *NeurIPS*, *ICLR*, etc, and top-tier journals such as *TPAMI*, *JAIR*, *TITS*, etc. I am an **Area Chair (AC)** for *NeurIPS* and actively review for AI conferences and journals, recognized with multiple best reviewer awards. 
