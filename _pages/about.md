...
* [06/2025] Checkout our [MetaBox-v2](https://github.com/GMC-DRL/MetaBox)! A major update offering broader optimization scenarios (single-objective, multi-objective, multi-modal, multi-task, etc), extensive benchmarks, even faster parallel training/inference, and more support for MetaBBO.
